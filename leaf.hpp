...
namespace leaf
{
    ...
    namespace distortion
    {
        ...
        struct oversampler
        {
            ...
            void init(int order, int extraQuality, LEAF& leaf = main) { tOversampler_init(&obj, order, extraQuality, &leaf); }
            void initToPool(int order, int extraQuality, tMempool* mempool) { tOversampler_initToPool(&obj, order, extraQuality, mempool); }
            ...
            float tick(float input, float* oversample, float (*effectTick)(float)) { return tOversampler_tick(&obj, input, oversample, effectTick); }
    ...
    namespace env
    {
        struct envelope
        {
            ...
            void init(float attack, float decay, int loop, LEAF& leaf = main) { tEnvelope_init(&obj, attack, decay, loop, &leaf); }
            void initToPool(float attack, float decay, int loop, tMempool* mempool) { tEnvelope_initToPool(&obj, attack, decay, loop, mempool); }
        ...
        struct exp_smooth
        {
            ...
            void initToPool(float val, float factor, tMempool* mempool) { tExpSmooth_initToPool(&obj, val, factor, mempool); }
        ...
        struct adsr
        {
            ...
            void init(float attack, float decay, float sustain, float release, LEAF& leaf = main) { tADSR_init(&obj, attack, decay, sustain, release, &leaf); }
        ...
        struct adsrs
        {
            ...
            void init(float attack, float decay, float sustain, float release, LEAF& leaf = main) { tADSRS_init(&obj, attack, decay, sustain, release, &leaf); }
            void initToPool(float attack, float decay, float sustain, float release, tMempool* mempool) { tADSRS_initToPool(&obj, attack, decay, sustain, release, mempool); }
        ...
        struct ramp
        {
            ...
            void init(float time, int samplesPerTick, LEAF& leaf = main) { tRamp_init(&obj, time, samplesPerTick, &leaf); }
            void initToPool(float time, int samplesPerTick, tMempool* mempool) { tRamp_initToPool(&obj, time, samplesPerTick, mempool); }
        ...
        struct ramp_up_down
        {
            ...
            void init(float upTime, float downTime, int samplesPerTick, LEAF& leaf = main) { tRampUpDown_init(&obj, upTime, downTime, samplesPerTick, &leaf); }
            void initToPool(float upTime, float downTime, int samplesPerTick, tMempool* mempool) { tRampUpDown_initToPool(&obj, upTime, downTime, samplesPerTick, mempool); }
        ...
        struct slide
        {
            ...
            void init(float upSlide, float downSlide, LEAF& leaf = main) { tSlide_init(&obj, upSlide, downSlide, &leaf); }
            void initToPool(float upSlide, float downSlide, tMempool* mempool) { tSlide_initToPool(&obj, upSlide, downSlide, mempool); }
    ...
    namespace electrical
    {
        struct wdf
        {
            ...
            void init(WDFComponentType type, float value, tWDF* rL, tWDF* rR, LEAF& leaf = main) { tWDF_init(&obj, type, value, rL, rR, &leaf); }
            void initToPool(WDFComponentType type, float value, tWDF* rL, tWDF* rR, tMempool* mempool) { tWDF_initToPool(&obj, type, value, rL, rR, mempool); }
            void free() { tWDF_free(&obj); }

            float tick(float sample, tWDF* outputPoint, uint8_t paramsChanged) { return tWDF_tick(&obj, sample, outputPoint, paramsChanged); }
            ...
            float getReflectedWaveDown(float input, float incident_wave) { return tWDF_getReflectedWaveDown(&obj, input, incident_wave); }
    ...
    namespace delay
    {
        struct delay
        {
            ...
            void init(uint32_t delay, uint32_t maxDelay, LEAF& leaf = main) { tDelay_init(&obj, delay, maxDelay, &leaf); }
            void initToPool(uint32_t delay, uint32_t maxDelay, tMempool* mempool) { tDelay_initToPool(&obj, delay, maxDelay, mempool); }
        ...
        struct linear_delay
        {
            ...
            void init(float delay, uint32_t maxDelay, LEAF& leaf = main) { tLinearDelay_init(&obj, delay, maxDelay, &leaf); }
            void initToPool(float delay, uint32_t maxDelay, tMempool* mempool) { tLinearDelay_initToPool(&obj, delay, maxDelay, mempool); }
        ...
        struct hermite_delay
        {
            ...
            void init(float delay, uint32_t maxDelay, LEAF& leaf = main) { tHermiteDelay_init(&obj, delay, maxDelay, &leaf); }
            void initToPool(float delay, uint32_t maxDelay, tMempool* mp) { tHermiteDelay_initToPool(&obj, delay, maxDelay, mp); }
            ...
            float tapOutInterpolated(uint32_t tapDelay, float alpha) { return tHermiteDelay_tapOutInterpolated(&obj, tapDelay, alpha); }
        ...
        struct allpass_delay
        {
            ...
            void init(float delay, uint32_t maxDelay, LEAF& leaf = main) { tAllpassDelay_init(&obj, delay, maxDelay, &leaf); }
            void initToPool(float delay, uint32_t maxDelay, tMempool* mempool) { tAllpassDelay_initToPool(&obj, delay, maxDelay, mempool); }
        ...
        struct tape_delay
        {
            ...
            void init(float delay, uint32_t maxDelay, LEAF& leaf = main) { tTapeDelay_init(&obj, delay, maxDelay, &leaf); }
            void initToPool(float delay, uint32_t maxDelay, tMempool* mempool) { tTapeDelay_initToPool(&obj, delay, maxDelay, mempool); }
    ...
    namespace filters
    {
        struct allpass
        {
            ...
            void init(float initDelay, uint32_t maxDelay, LEAF& leaf = main) { tAllpass_init(&obj, initDelay, maxDelay, &leaf); }
            void initToPool(float initDelay, uint32_t maxDelay, tMempool* mempool) { tAllpass_initToPool(&obj, initDelay, maxDelay, mempool); }
        ...
        struct two_pole
        {
            ...
            void setResonance(float freq, float radius, int normalize) { tTwoPole_setResonance(&obj, freq, radius, normalize); }
        ...
        struct bi_quad
        {
            ...
            void setResonance(float freq, float radius, int normalize) { tBiQuad_setResonance(&obj, freq, radius, normalize); }
            void setCoefficients(float b0, float b1, float b2, float a1, float a2) { tBiQuad_setCoefficients(&obj, b0, b1, b2, a1, a2); }
        ...
        struct svf
        {
            ...
            void initToPool(SVFType type, float freq, float Q, tMempool* mempool) { tSVF_initToPool(&obj, type, freq, Q, mempool); }
        ...
        struct efficient_svf
        {
            ...
            void init(SVFType type, uint16_t input, float Q, LEAF& leaf = main) { tEfficientSVF_init(&obj, type, input, Q, &leaf); }
            void initToPool(SVFType type, uint16_t input, float Q, tMempool* mempool) { tEfficientSVF_initToPool(&obj, type, input, Q, mempool); }
        ...
        struct butterworth
        {
            ...
            void initToPool(int N, float f1, float f2, tMempool* mempool) { tButterworth_initToPool(&obj, N, f1, f2, mempool); }
        ...
        struct fir
        {
            ...
            void initToPool(float* coeffs, int numTaps, tMempool* mempool) { tFIR_initToPool(&obj, coeffs, numTaps, mempool); }
        ...
        struct vzfilter
        {
            ...
            void init(VZFilterType type, float freq, float Q, LEAF& leaf = main) { tVZFilter_init(&obj, type, freq, Q, &leaf); }
            void initToPool(VZFilterType type, float freq, float Q, tMempool* mempool) { tVZFilter_initToPool(&obj, type, freq, Q, mempool); }
            ...
            void setFreqAndBandwidthEfficientBP(float freq, float bw) { tVZFilter_setFreqAndBandwidthEfficientBP(&obj, freq, bw); }
            void setGain(float gain) { tVZFilter_setGain(&obj, gain); }
            void setResonance(float res) { tVZFilter_setResonance(&obj, res); }
            void setFrequencyAndResonance(float freq, float res) { tVZFilter_setFrequencyAndResonance(&obj, freq, res); }
            void setFrequencyAndResonanceAndGain(float freq, float res, float gains) { tVZFilter_setFrequencyAndResonanceAndGain(&obj, freq, res, gains); }
            void setFrequencyAndBandwidthAndGain(float freq, float BW, float gain) { tVZFilter_setFrequencyAndBandwidthAndGain(&obj, freq, BW, gain); }
            void setFrequencyAndResonanceAndMorph(float freq, float res, float morph) { tVZFilter_setFrequencyAndResonanceAndMorph(&obj, freq, res, morph); }
        ...
        struct ladder_filter
        {
            ...
            void initToPool(float freq, float Q, tMempool* mempool) { tLadderFilter_initToPool(&obj, freq, Q, mempool); }
    ...
    namespace sampling
    {
        struct buffer
        {
            ...
            void setBuffer(float* externalBuffer, int length, int channels, int sampleRate) { tBuffer_setBuffer(&obj, externalBuffer, length, channels, sampleRate); }
        ...
        struct auto_sampler
        {
            ...
            void initToPool(tBuffer* b, tMempool* mp, LEAF& leaf = main) { tAutoSampler_initToPool(&obj, b, mp, &leaf); }
    ...
    namespace dyn
    {
        ...
        struct threshold
        {
            ...
            void initToPool(float low, float high, tMempool* mempool) { tThreshold_initToPool(&obj, low, high, mempool); }
    ...
    namespace analysis
    {
        struct envelope_follower
        {
            ...
            void setDecayCoefficient(float decayCoefficient) { tEnvelopeFollower_setDecayCoefficient(&obj, decayCoefficient); }
            void setAttackThreshold(float attackThreshold) { tEnvelopeFollower_setAttackThreshold(&obj, attackThreshold); }
        };
        ...
        struct zero_crossing_counter
        {
            ...
            void initToPool(int maxWindowSize, tMempool* mempool) { tZeroCrossingCounter_initToPool(&obj, maxWindowSize, mempool); }
        ...
        struct env_pd
        {
            ...
            void init(int windowSize, int hopSize, int blockSize, LEAF& leaf = main) { tEnvPD_init(&obj, windowSize, hopSize, blockSize, &leaf); }
            void initToPool(int windowSize, int hopSize, int blockSize, tMempool* mempool) { tEnvPD_initToPool(&obj, windowSize, hopSize, blockSize, mempool); }
        ...
        struct attack_detection
        {
            ...
            void init(int blocksize, int atk, int rel, LEAF& leaf = main) { tAttackDetection_init(&obj, blocksize, atk, rel, &leaf); }
            void initToPool(int blocksize, int atk, int rel, tMempool* mempool) { tAttackDetection_initToPool(&obj, blocksize, atk, rel, mempool); }
        ...
        struct period_detection
        {
            ...
            void init(float* in, int bufSize, int frameSize, LEAF& leaf = main) { tPeriodDetection_init(&obj, in, bufSize, frameSize, &leaf); }
            void initToPool(float* in, int bufSize, int frameSize, tMempool* mempool) { tPeriodDetection_initToPool(&obj, in, bufSize, frameSize, mempool); }
        ...
        struct zero_crossing_collector
        {
            ...
            void init(int windowSize, float hysteresis, LEAF& leaf = main) { tZeroCrossingCollector_init(&obj, windowSize, hysteresis, &leaf); }
        ...
        struct pitch_detector
        {
            ...
            void init(float lowestFreq, float highestFreq, LEAF& leaf = main) { tPitchDetector_init(&obj, lowestFreq, highestFreq, &leaf); }
    ...
    namespace physical
    {
        struct pluck
        {
            ...
            void init(float lowestFrequency, LEAF leaf); // float* delayBuff[DELAY_LENGTH]) { tPluck_init(&obj, lowestFrequency, delayBuff[DELAY_LENGTH]); }
            void initToPool(float lowestFrequency, tMempool* mempool) { tPluck_initToPool(&obj, lowestFrequency, mempool); }
        ...
        struct karplus_strong
        {
            ...
            void initToPool(float lowestFrequency, tMempool* mempool) { tKarplusStrong_initToPool(&obj, lowestFrequency, mempool); }
        ...
        struct simple_living_string
        {
            ...
            void setLevSmoothFactor(float levSmoothFactor) { tSimpleLivingString_setLevSmoothFactor(&obj, levSmoothFactor); }
        ...
        struct simple_living_string2
        {
            ...
            void setLevSmoothFactor(float levSmoothFactor) { tSimpleLivingString2_setLevSmoothFactor(&obj, levSmoothFactor); }
        ...
        struct complex_living_string
        {
            ...
            void setLevSmoothFactor(float levSmoothFactor) { tComplexLivingString_setLevSmoothFactor(&obj, levSmoothFactor); }
        ...
        struct reed_table
        {
            ...
            void initToPool(float offset, float slope, tMempool* mempool) { tReedTable_initToPool(&obj, offset, slope, mempool); }
    ...
    namespace fx
    {
        ...
        struct pitch_shift
        {
            ...
            void init(tDualPitchDetector* dual_pitch_detector, int bufSize, LEAF& leaf = main) { tPitchShift_init(&obj, dual_pitch_detector, bufSize, &leaf); }
            void initToPool(tDualPitchDetector* dual_pitch_detector, int bufSize, tMempool* mempool) { tPitchShift_initToPool(&obj, dual_pitch_detector, bufSize, mempool); }
        ...
        struct retune
        {
            ...
            void init(int numVoices, float minInputFreq, float maxInputFreq, int bufSize, LEAF& leaf = main) { tRetune_init(&obj, numVoices, minInputFreq, maxInputFreq, bufSize, &leaf); }
        ...
        struct formant_shifter
        {
            ...
            void ioSamples(float* in, float* out, int size, float fwarp) { tFormantShifter_ioSamples(&obj, in, out, size, fwarp); }
    ...
    namespace osc
    {
        ...
        struct table
        {
            ...
            void initToPool(float* table, int size, tMempool* mempool) { tTable_initToPool(&obj, table, size, mempool); }
        ...
        struct wave_table
        {
            ...
            void init(float* table, int size, float maxFreq, LEAF& leaf = main) { tWaveTable_init(&obj, table, size, maxFreq, &leaf); }
            void initToPool(float* table, int size, float maxFreq, tMempool* mempool) { tWaveTable_initToPool(&obj, table, size, maxFreq, mempool); }
        ...
        struct wave_osc
        {
            ...
            void init(tWaveTable* tables, int numTables, LEAF& leaf = main) { tWaveOsc_init(&obj, tables, numTables, &leaf); }
            void initToPool(tWaveTable* tables, int numTables, tMempool* mp) { tWaveOsc_initToPool(&obj, tables, numTables, mp); }
        ...
        struct wave_table_s
        {
            ...
            void init(float* table, int size, float maxFreq, LEAF& leaf = main) { tWaveTableS_init(&obj, table, size, maxFreq, &leaf); }
            void initToPool(float* table, int size, float maxFreq, tMempool* mempool) { tWaveTableS_initToPool(&obj, table, size, maxFreq, mempool); }
        ...
        struct wave_osc_s
        {
            ...
            void init(tWaveTableS* tables, int numTables, LEAF& leaf = main) { tWaveOscS_init(&obj, tables, numTables, &leaf); }
            void initToPool(tWaveTableS* tables, int numTables, tMempool* mempool) { tWaveOscS_initToPool(&obj, tables, numTables, mempool); }
